      ...
      return [
        {
          ...
          icon: '🌙',
          description: 'Rust ve FiveM gece vakitlerinde karanlık alanları ve binaların içini aydınlatır.',
          exePattern: 'RustClient.exe;FiveM.exe;GTA5.exe',
          hotkey: 'F9',
          isBuiltin: true,
        ...
        },
        {
          ...
          icon: '🕳️',
          description: 'Zifiri karanlık tüneller ve yeraltı mağaraları için maksimum gama ve gölge detayı.',
          exePattern: 'RustClient.exe;EscapeFromTarkov.exe',
          hotkey: 'F11',
          isBuiltin: true,
          autoApplyOnLaunch: true,
        ...
        },
        {
          ...
          exePattern: 'cs2.exe;VALORANT-Win64-Shipping.exe;FiveM.exe',
          hotkey: 'F8',
          isBuiltin: true,
          autoApplyOnLaunch: true,
        ...
        },
        {
          ...
          exePattern: 'GTA5.exe;Cyberpunk2077.exe',
          hotkey: 'F7',
          isBuiltin: true,
          autoApplyOnLaunch: true,
        ...
        },
        {
          ...
          exePattern: 'chrome.exe;msedge.exe;Code.exe',
          hotkey: 'Alt+F8',
          isBuiltin: true,
          autoApplyOnLaunch: true,
